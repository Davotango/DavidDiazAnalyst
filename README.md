...
## 📂 Recent Projects
  ...
  - 🐧 **[Palmer Penguins Regression (PDF)](./Penguin_Regression_Project.pdf)** — Built a linear regression model with 75.9% R² accuracy to prioritize key biological metrics.
